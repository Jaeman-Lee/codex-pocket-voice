...
- 프롬프트·경로·응답을 노출하지 않는 opt-in Android 완료·승인·오류 알림과 retained 작업 바로 열기
...
- v2 opt-in PocketLink LAN TLS listener, 10분 QR bootstrap, 8초 reviewed DNS-SD 주소 discovery와 Android Keystore device-certificate/SPKI-pin mTLS foreground tunnel (CI 전용)
